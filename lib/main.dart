...
void _verifyDependencies() {
  ...
  for (var dep in dependencies) {
    try {
      ...
      print('✅ $dep registered correctly.');
    } catch (e) {
      print('❌ $dep registration failed: $e');
    }
  }

  // Verify favorite use cases
  print('🔍 Verifying favorite use cases...');
  for (var useCase in useCases) {
    try {
      switch (useCase) {
        case 'GetFavoritesUseCase':
          sl<GetFavoritesUseCase>();
          break;
        case 'AddFavoriteUseCase':
          sl<AddFavoriteUseCase>();
          break;
        case 'RemoveFavoriteUseCase':
          sl<RemoveFavoriteUseCase>();
          break;
      }
      print('✅ $useCase registered correctly.');
    } catch (e) {
      print('❌ $useCase registration failed: $e');
    }
  }
