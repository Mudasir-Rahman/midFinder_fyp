...
class MedicineModel extends MedicineEntity {
  const MedicineModel({
    ...
    String? pharmacyName, // ✅ Read-only field
  }) : super(
    id: id ?? '',
    ...
    pharmacyName: pharmacyName, // 👈 this goes into your Entity
  );

  // 🧩 Factory from Supabase JSON (with pharmacy join)
  factory MedicineModel.fromJson(Map<String, dynamic> json) {
    final pharmacy = json['pharmacies'] ?? {}; // ← joined pharmacy data
    ...
    return MedicineModel(
      ...
      pharmacyName: pharmacy['pharmacy_name'], // ✅ fetched automatically
    );
  }
