...
import '../../bloc/favorite_event.dart';
import '../../bloc/favorite_state.dart';
import '../widget/favoriteswrapper.dart';
...
class PatientFavoritesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FavoritesWrapper(
      patientId: patientId,
      child: _FavoritesScreenContent(patientId: patientId),
    );
  }
}

// Separate the content to avoid BlocProvider conflicts
class _FavoritesScreenContent extends StatelessWidget {
  final String patientId;

  const _FavoritesScreenContent({required this.patientId});
